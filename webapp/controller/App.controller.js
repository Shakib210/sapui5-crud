	...
	return Controller.extend("sap.ui.crud.controller.App", {
		...
		onSearchUserName: function () {
			var oView = this.getView(),
				sValue = oView.byId("userNameField").getValue(),
				oFilter = new Filter("UserName", FilterOperator.Contains, sValue);
		...
		onSearch: function () {
			...
			console.log('search text', sValue)
			if (sValue) {
				aFilter.push(new Filter("FirstName", FilterOperator.Contains, sValue));
			}

			var oList = this.byId("peopleList");
			var oBinding = oList.getBinding("items");
			oBinding.filter(aFilter, FilterType.Application);
			// 	oFilter = new Filter("FirstName", FilterOperator.Contains, sValue);

			// oView.byId("peopleList").getBinding("items").filter(oFilter, FilterType.Application);
		},

		onSearchFirstName: function () {
			var oView = this.getView(),
				sValue = oView.byId("searchFieldFirstName").getValue(),
				oFilter = new Filter("FirstName", FilterOperator.Contains, sValue);

			oView.byId("peopleList").getBinding("items").filter(oFilter, FilterType.Application);
		},

		onTestCheck: function () {
			var oView = this.getView();
			...
			this.onCreate({ userName, firstName, lastName, age })
			this.onSave()
